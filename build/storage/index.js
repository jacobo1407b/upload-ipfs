...
function ipfsClient() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, ipfs_http_client_1.create)({
                ...
                case 1:
                    ipfs = _a.sent();
                    return [2 /*return*/, ipfs];
            }
        });
    });
}
function loadData(buffer, uid) {
    return __awaiter(this, void 0, void 0, function () {
        var ipfs, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ipfsClient()];
                case 1:
                    ipfs = _a.sent();
                    return [4 /*yield*/, ipfs.add({
                            path: uid,
                            content: buffer
                        })];
                case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ipfs = _a.sent();
                    return [4 /*yield*/, ipfs.name.publish(cid)];
